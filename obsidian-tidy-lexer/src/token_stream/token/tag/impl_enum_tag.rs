        ...
        ::pastey::paste! {
            ...
            impl<$( $a )?> $name_main<$( $a )?> {
                ...
                $(
                    $(
                        #[must_use]
                        $vis_main fn [<as_ $variant:snake>](&self) -> ::core::option::Option<&<$internal_type as $crate::__private::AsRefTarget>::Target>
                        where
                        ...
                        #[must_use]
                        $vis_main fn [<as_mut_ $variant:snake>](&mut self) -> ::core::option::Option<&mut <$internal_type as $crate::__private::AsMutTarget>::Target>
                        where
